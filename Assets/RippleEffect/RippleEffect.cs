...
public class RippleEffect : MonoBehaviour
{
    ...
    [Range(0.01f, 1.0f)]
    public float refractionStrength = 0.067f;

    public Color reflectionColor = Color.gray;

    [Range(0.01f, 1.0f)]
    public float reflectionStrength = 0.22f;

    [Range(0.50f, 3.0f)]
    public float waveSpeed = 0.78f;

    [Range(0.0f, 3.0f)]
    public float dropInterval = 2.8f;
    ...
    void UpdateShaderParameters()
    {
        ...
        material.SetVector("_Drop1", droplets[0].MakeShaderParameter(1.0f));
        material.SetVector("_Drop2", droplets[1].MakeShaderParameter(1.0f));
        material.SetVector("_Drop3", droplets[2].MakeShaderParameter(1.0f));

        material.SetColor("_Reflection", reflectionColor);
        material.SetVector("_Params1", new Vector4(1.0f, 1, 1 / waveSpeed, 0));
        material.SetVector("_Params2", new Vector4(1, 1, refractionStrength, reflectionStrength));
    }
